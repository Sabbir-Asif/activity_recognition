...
# === Configuration ===
video_path = "../data/videos/new_video_1.mp4"         # Input video file
output_video_path = "output_with_new_video_1.mp4"
output_excel_path = "badge_positions_tracked_new_video_1.xlsx"
resize_dim = (800, 600)
max_distance = 150
merge_distance = 80  # Distance threshold to merge IDs

# HSV color range (from your static test)
...
while True:
    ...
    for contour in contours:
        if cv2.contourArea(contour) > 1:  # ignore very small regions
    ...
    if frame_idx % int(fps) == 0:
        ...
        status_msg += f"Detected: {detected_count} | Tracking: {tracked_count} hands"
        if merge_count > 0:
